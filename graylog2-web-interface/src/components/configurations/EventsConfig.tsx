        ...
        <BootstrapModalForm
          ...
          <fieldset>
            <FormGroup controlId="search-timeout-field">
              ...
              />
              <HelpBlock>
                Elasticsearch 查询中断前的时间量。（最小超时时间为 1 秒）
              </HelpBlock>
            </FormGroup>
            ...
            <FormGroup controlId="catch-up-window">
              ...
              />
              <HelpBlock>
                如果事件处理器执行滞后，将使用此窗口大小对旧数据运行查询以加快处理速度。（如果事件定义的“搜索最近”设置更大，则此设置将被忽略）
              </HelpBlock>
            </FormGroup>
            <FormGroup controlId="notification-tcp-keepalive-field">
              ...
              />
              <HelpBlock>如果启用，通知的 HTTP 连接将发送 TCP 保活探测</HelpBlock>
            </FormGroup>
          </fieldset>
        </BootstrapModalForm>
      )}
