...
public class DataNodeRestApiProxyResource extends RestResource {
    ...
    @GET
    @ApiOperation(value = "向数据节点的 API 发送 GET 请求")
    ...
    @POST
    @ApiOperation(value = "向数据节点的 API 发送 POST 请求")
    @AuditEvent(type = DATANODE_API_REQUEST, captureRequestEntity = false, captureResponseEntity = false)
    ...
    @PUT
    @ApiOperation(value = "向数据节点的 API 发送 PUT 请求")
    @AuditEvent(type = DATANODE_API_REQUEST, captureRequestEntity = false, captureResponseEntity = false)
    ...
    @DELETE
    @ApiOperation(value = "向数据节点的 API 发送 DELETE 请求")
    @AuditEvent(type = DATANODE_API_REQUEST, captureRequestEntity = false, captureResponseEntity = false)
