...
public class ClusterNodeMetricsResource extends ProxiedResource {
    ...
    public MetricNamesResponse metricNames(@ApiParam(name = "nodeId", value = "我们想要其度量的节点的 ID。", required = true)
    ...
    public MetricsSummaryResponse multipleMetrics(@ApiParam(name = "nodeId", value = "我们想要其度量的节点的 ID。", required = true)
    ...
    public MetricsSummaryResponse byNamespace(@ApiParam(name = "nodeId", value = "我们想要其度量的节点的 ID。", required = true)
                                              @PathParam("nodeId") String nodeId,
