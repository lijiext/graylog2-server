...
class SlackNotificationForm extends React.Component<Props, any> {
  ...
  render() {
    ...
    const { isBacklogSizeEnabled, backlogSize } = this.state;
    const element = <p>要附加在告警标题下方的自定义消息。请参阅 <DocumentationLink text="docs" page="alerts#notifications" /> 更多详细信息。</p>;
    ...
    return (
      <>
        ...
        <FormGroup>
          ...
          <HelpBlock>限制作为 Slack 通知一部分发送的积压消息数量。如果设置为 0，则不强制执行限制。</HelpBlock>
        </FormGroup>
